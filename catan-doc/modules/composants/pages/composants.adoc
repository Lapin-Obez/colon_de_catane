...
[plantuml]
----
include::partials$connectGameSequenceDiag.plantuml[]
----

.Création d'une Game
[plantuml]
----
include::partials$createGameSequenceDiag.plantuml[]
----

.Construction d'une colonie
[plantuml]
----
include::partials$buildColonySequenceDiag.plantuml[]
----

.Construction d'une ville, qui est l'upgrade d'une colonie
[plantuml]
----
include::partials$upgradeToCitySequenceDiag.plantuml[]
----

.Construction d'une route
[plantuml]
----
include::partials$buildRoadSequenceDiag.plantuml[]
----

.Commerce avec la banque
[plantuml]
----
include::partials$bankExchangeSequenceDiag.plantuml[]
----

.Lancer des dés
[plantuml]
----
include::throwDiceSequenceDiag.plantuml[]
----

.Fin du tour (Cf Fin du tour jeu d'un joueur, problème de génération avec PlantUML)
[plantuml]
----
include::endGameTurnSequenceDiag.plantuml[]
----

.Fin du jeu (Cf Fin du jeu)
[plantuml]
----
include::endGameSequenceDiag.plantuml[]
----
